...
import { AuthProvidersDto, LoginDto, RegisterDto, UserWithSecrets } from "../../libs/dto";
...
export class AuthService {
  ...
  async forgotPassword(email: string) {
    ...
    const subject = "Reset your Grzy password";
  ...
  async setup2FASecret(email: string) {
    ...
    const uri = authenticator.keyuri(email, "Grzy", secret);
